...
public class RealSpindexerS extends SpindexerS {
    public class SpindexerConstants {
        ...
        public static final Voltage kFastVoltage = Volts.of(6);
        public static final Voltage kReverseVoltage = Volts.of(-4.0);

        // Feedforward Constants
        public static final double kS = 0;
        // Motor Properties
        public static final int kStatorCurrentLimit = 200;
    ...
    // Motor Object
    private TalonFX m_spindexerMotor = new TalonFX(SpindexerConstants.kCANID, TunerConstants.kLowerBus);
