...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(3.43).withKI(0).withKD(0.0)
        .withKS(1.67).withKV(10 / kSpeedAt12Volts.baseUnitMagnitude());
    ...
    public static final SwerveDrivetrainConstants DrivetrainConstants = new SwerveDrivetrainConstants()
            .withCANBusName(kLowerBus.getName())
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.00732);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.08984375);
