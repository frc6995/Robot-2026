...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d BALLL2 = new Pose2d(8.306, 6.792, Rotation2d.fromRadians(-1.222));
        public static final Pose2d BALLL3 = new Pose2d(7.326, 6.593, Rotation2d.fromRadians(-1.571));
        ...
        public static final Pose2d BALLR2 = new Pose2d(8.306, 1.277, Rotation2d.fromRadians(1.571));
        public static final Pose2d BALLR3 = new Pose2d(7.326, 1.499, Rotation2d.fromRadians(1.571));
        ...
        public static final Pose2d HELPS = new Pose2d(3.822, 0.539, Rotation2d.fromRadians(3.142));
        public static final Pose2d L_SWEEP1 = new Pose2d(8.302, 5.2, Rotation2d.fromRadians(-1.678));
        public static final Pose2d L_SWEEP2 = new Pose2d(6.985, 4.991, Rotation2d.fromRadians(-3.125));
        public static final Pose2d L_SWEEP3 = new Pose2d(5.927, 5.287, Rotation2d.fromRadians(1.595));
        public static final Pose2d L_SWEEP4 = new Pose2d(6.112, 6.301, Rotation2d.kZero);
        public static final Pose2d L_SWEEP5 = new Pose2d(6.122, 6.989, Rotation2d.fromRadians(2.178));
        public static final Pose2d L_SWEEP6 = new Pose2d(5.12, 7.452, Rotation2d.fromRadians(3.123));
        public static final Pose2d R_SWEEP1 = new Pose2d(8.302, 2.852, Rotation2d.fromRadians(1.678));
        public static final Pose2d R_SWEEP2 = new Pose2d(5.927, 2.765, Rotation2d.fromRadians(-1.595));
        public static final Pose2d R_SWEEP3 = new Pose2d(5.927, 2.765, Rotation2d.fromRadians(-1.595));
        public static final Pose2d R_SWEEP4 = new Pose2d(6.112, 1.751, Rotation2d.kZero);
        public static final Pose2d R_SWEEP5 = new Pose2d(6.122, 1.063, Rotation2d.fromRadians(-2.178));
        public static final Pose2d STA1 = new Pose2d(0.994, 0.661, Rotation2d.fromRadians(3.142));
        public static final Pose2d STOPL1 = new Pose2d(8.284, 5.106, Rotation2d.fromRadians(4.712));
        ...
        public static final Pose2d STOPR1 = new Pose2d(8.284, 3.497, Rotation2d.fromRadians(1.571));
        public static final Pose2d STOPR2 = new Pose2d(7.301, 3.552, Rotation2d.fromRadians(1.571));
        ...
        public static final Pose2d TRL1 = new Pose2d(4.303, 7.513, Rotation2d.kZero);
        public static final Pose2d TRL2 = new Pose2d(4.912, 7.513, Rotation2d.fromRadians(3.142));
        public static final Pose2d TRR1 = new Pose2d(4.303, 0.539, Rotation2d.kZero);
        public static final Pose2d TRR2 = new Pose2d(4.303, 0.539, Rotation2d.fromRadians(3.142));
        public static final Pose2d L_SWEEP100 = new Pose2d(5.751, 7.397, Rotation2d.fromRadians(1.614));
